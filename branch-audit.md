...
The repository therefore needs no branch deletion. The canonical branch remains main after the repository rename.
...
Use main for the canonical public record. Any temporary development branch must have a descriptive claim or documentation name and must not remain as an unexplained published branch.
